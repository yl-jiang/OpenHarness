...
def create_default_command_registry(
    ...
    registry.register(
        SlashCommand(
            "share",
            "Create a shareable transcript snapshot",
            _share_handler,
            remote_invocable=False,
            remote_admin_opt_in=True,
        )
    ...
    registry.register(SlashCommand(
        ...
        remote_invocable=False,
        remote_admin_opt_in=True,
        subcommands=["show", "list", "encode", "decode", "sdk", "spawn", "output", "stop"],
    ))
    ...
    registry.register(SlashCommand("provider", "Show or switch provider profiles", _provider_handler, remote_invocable=False, remote_admin_opt_in=True))
    registry.register(SlashCommand("model", "Show or update the default model", _model_handler, remote_invocable=False, remote_admin_opt_in=True))
    ...
    registry.register(
        SlashCommand(
            ...
            remote_invocable=False,
            remote_admin_opt_in=True,
            subcommands=["list", "run", "stop", "show", "update", "output"],
        )
    )
