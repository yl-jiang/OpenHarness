...
class SkillManagerTool(BaseTool):
    ...
    description = (
        ...
        "Create one after a complex task succeeds, a tricky error is overcome, "
        "or a non-trivial workflow is discovered. Patch a skill immediately when "
        "you find stale instructions, missing steps, or new pitfalls while using it.\n\n"
        "Actions:\n"
