...
from wolo.config import load_config, save_config as _save_config
from wolo.core.models import ProjectSignal, ProjectSnapshot, ProjectCheckin
...
class WoloService:
    ...
    def update_config(self, updates: dict[str, Any]) -> dict[str, Any]:
        ...
        new_config = WoloConfig.model_validate(merged)
    ...
    def create_project(self, data):
        ...
        from wolo.core.models import Project, Milestone
    ...
    def create_project_link(self, project_id, data):
        from uuid import uuid4
        from wolo.core.utils import _now
        from wolo.core.models import ProjectLink
    ...
    def create_project_alias(self, project_id, alias_text):
        from uuid import uuid4
        from wolo.core.models import ProjectAlias
        from wolo.core.utils import _now
    ...
    def accept_project_suggestion(self, suggestion_id):
        ...
        import json
        from uuid import uuid4
        from wolo.core.models import Project, ProjectLink, Milestone
        from wolo.core.utils import _now
    ...
    async def scan_for_projects(self):
        ...
        from wolo.core.models import ProjectSuggestion
        from wolo.core.utils import _now
        from uuid import uuid4
        import json
    ...
    def delete_memory(self, memory_id: str) -> bool:
        ...
        from wolo.core.memory import delete_memory_file
